...
LSP 客户端库（perihelion-lsp）和 LSP 中间件，提供代码智能功能（定义跳转、引用查找、hover 等）及文件变更同步。
...
| 维度 | 选型 |
|------|------|
| LSP 客户端 | perihelion-lsp 独立 crate，基于 jsonrpc/stdio transport |
...
**涉及文件:** perihelion-lsp/src/jsonrpc/transport.rs, perihelion-lsp/src/client.rs, perihelion-lsp/src/pool.rs, perihelion-lsp/src/error.rs, rust-agent-middlewares/src/lsp/tool.rs
**CLAUDE.md 链接:** true
