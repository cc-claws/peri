...
- `rust-agent-tui/src/app/agent_ops.rs:152-173` — 缓存率检查逻辑（使用累计值）
...
- `rust-create-agent/src/agent/token.rs:57-65` — `cache_hit_rate()` 实现（累计值）
- `rust-create-agent/src/agent/token.rs:70-78` — `last_cache_hit_rate()` 实现（当次值）
